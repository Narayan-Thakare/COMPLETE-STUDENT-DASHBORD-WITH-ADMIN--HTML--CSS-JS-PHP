...
?>
 -->
            ...
            <form action="\Sammer\student_register\admin\PayUpdate.php" method="post">
            <h4
...
<label class="block text-sm">
                    ...
                    <input type="text"
                           name="Fees"
                           class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                           value="<?php echo htmlspecialchars($row['Fees']); ?>"
                    />
                </label>
                ...
                <label class="block text-sm">
                    <span class="text-gray-700 dark:text-gray-400">Card_Number</span>
                    <input type="text"
                           name="card"
                           class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                           value="<?php echo htmlspecialchars($row['card']); ?>"
                    />
                </label>
                 ...
                 <label class="block text-sm">
                    ...
                    <input type="text"
                           name="number"
                           class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                           value="<?php echo htmlspecialchars($row['number']); ?>"
                    />
                </label>
