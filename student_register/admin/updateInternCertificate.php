...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $studentId = $_POST["id"]; // Assuming you have a field like 'student_id' to identify the student you want to update

    // Handle C++ Certificate Upload
    if ($_FILES["certificate"]["error"] === UPLOAD_ERR_OK) {
        $cppCertificateImage = $_FILES["certificate"]["tmp_name"];
        ...
        $sql = "UPDATE internship SET certificate = ? WHERE id = ?";
