  ...
  <div class="search-results">
    <!--php data base code -->
        ...
        $sql = "SELECT * FROM internship ORDER BY  	id  DESC";
          ...
          $sql = "SELECT * FROM internship where full_name  like'".$_GET['uname']."%'";
          //echo $sql;
...
<li class="relative px-6 py-3">
              ...
              <a
                class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                href="\Sammer\student_register\admin\payment.php"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
...
<div class="px-6 my-6">
 <a href="\Sammer\student_register\admin\forms.html"> <button on click=""
  ...
  <div class="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
    <form action="\Sammer\student_register\admin\showintership.php" class="flex">
...
<th class="px-4 py-3">receipt_number</th> -->
          ...
          <td class="px-4 py-3 text-sm">
            <?php echo $row["portfolio_website"]; ?>
          </td>
          <td class="px-4 py-3 text-sm">
            <?php echo $row["email"]; ?>
          </td>
                      <!-- ...................... -->
                      <!-- <td class="px-4 py-3 text-sm">
            <a href="\Sammer\student_register\admin\ShowInternEdit.php?id=<?php echo $row["id"]; ?>">Edit</a>

          </td>
                      <td class="px-4 py-3 text-sm">
                      <div>
                      <a href="\Sammer\student_register\admin\PayShow.php?student_id=<?php echo $row["student_id"]; ?>">Pay</a>

              </div>

              <td class="px-4 py-3 text-sm">
                      <div>
                      <a href="\Sammer\student_register\admin\IdexEdit.php?student_id=<?php echo $row["student_id"]; ?>">Show Data</a>
